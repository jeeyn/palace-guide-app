...
public class SurroundingsActivity extends AppCompatActivity
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnRoute:
                Intent intent = new Intent(SurroundingsActivity.this, RouteActivity.class);
                intent.putExtra("gungLatitude", mPosition.latitude);
                intent.putExtra("gungLongitude", mPosition.longitude);
